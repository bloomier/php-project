    ...
    var __init__={
        bind_function : function(){
            $(".notify-group-save").bind("click", function(){
                ...
                $.post(__ROOT__+"/Security/NotifyGroup/add",param).success(function(json){
                    Message.init({
                        text: json.msg,
        ...
        init_tree : function(){
            $.post(__ROOT__+"/Security/NotifyGroup/queryUserGroup").success(function(json){
                ...
                $.each(json.rows, function(point, item){
                    ...
                    $.each(item.list, function(subPoint, subItem){
                        var childNode = {title:subItem.user_NAME,name:subItem.user_NAME, id:subItem.user_ID};
