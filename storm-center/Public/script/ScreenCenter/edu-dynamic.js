...
(function(){
    ...
    var o={
        ...
        autoPlay:function(){
            ...
            if(autoPlay){
                ...
                setInterval(function(){
                    $.post(__WEBROOT__ + "/ScreenCenter/EduDynamic/refresh").success(function(){
    ...
    var __reload__={
        ...
        loadOtherData:function(){
            var w=this;
            $.ajax({
                url:__WEBROOT__+"/ScreenCenter/EduDynamic/zeroDayData",
                async:false,
                success:function(json){
                    if(json.code>0){
        ...
        loadData:function(location){
            ...
            var w=this;
            $.ajax({
                url:__WEBROOT__+"/ScreenCenter/EduDynamic/getLocationData",
