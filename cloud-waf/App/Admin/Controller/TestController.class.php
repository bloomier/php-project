...
//        dump($result);
    ...
    public function edit(){
        ...
        $config=array(
            ip=>"61.175.225.150",
            port=>80,
            domain=>array("www.huzhouwh.com",
                "stb.huzhou.gov.cn"
                ,"fgw.huzhou.gov.cn"
                ,"www.hzssfj.gov.cn"
                ,"www.hzpfw.com"
                ,"whsc.huzhou.cn"
                ,"hzplan.huzhou.gov.cn"),
            rule=>1,
            bypass => 1,
            //zone_rule => $zone_rule,
            id=>"5757c6ba42a3f"
    ...
    public function createUser(){
        ...
        $exists2=$umd->where(array(username =>"1610050682102067"))->find();
        if(!$exists2){
            $_id=$umd->getMongoNextId();
            $user=array(_id=>$_id,username=>"1610050682102067",name=>"1610050682102067",roles=>array(4));
