    ...
    var __function__= {
        ...
        worldAreaRank:function(data,opt,pie,tableName){
            ...
            if(arr.length>0){
                ...
                tbody.html("<tr><td align='center' colspan='3'>暂无源区域数据</td></tr>");
            }
    ...
    cloudwaf={
        ...
        view:{
            load:function(){
                ...
                $('#attack_visit_line').height(h *.6);
                $('#device_spread_pie').height(h *.5);
                $('#browser_spread_pie').height(h *.4);
                ...
                require(
                    ...
                    function (ec) {
                       ...
                       /* $(".echarts",$('#cloudwaf_id')).each(function(i,obj){
                        ...
                        var init=function(){
                            w.attack_visit_line= ec.init(document.getElementById('attack_visit_line'));
                            w.device_spread_pie= ec.init(document.getElementById('device_spread_pie'));
                            w.browser_spread_pie= ec.init(document.getElementById('browser_spread_pie'));
            ...
            summary:function(){
                ...
                if((summary.flow.all * 8 /1024/1024)>1024){
                    $(".flow_all").parent("div").append("G");
                }else{
                    $(".flow_all").parent("div").append("M");
                }
            },
            daily_attack_visit_flow_line:function(){
                ...
                cloudwaf.options.attack_visit_line.series[2].data=_flowOut;
                cloudwaf.options.attack_visit_line.series[3].data=_flowIn;
            ...
            visitip_topn:function(){
                ...
                if(revert.length>0){
                    $.each(revert,function(i,obj){
                        var color=tableBgColor[i+""]||"bg-blue";
                        var pecent=(obj.count*100/total).toFixed(2);
                        var tr=$("<tr><td>"+obj.ip+"</td><td><div>"+obj.location+"</div></td><td>"+obj.count+"</td><td>"+__function__.pecentItem(pecent,color)+"</td></tr>");

                        tr.appendTo(tbody);
                    });
                }else{
                    tbody.html("<tr><td align='center' colspan='4'>暂无访问源IP数据</td></tr>");
                }
            ...
            attack_dest:function(){
                ...
                if(arr.length>0){
                    ...
                    tbody.html("<tr><td align='center' colspan='3'>暂无攻击数据</td></tr>");
                }
            ...
            attack_topN:function(){
               ...
               if(data['items'].length>0) {
                   ...
                   $("tbody",$("#attack_topn_table")).html("<tr><td align='center' colspan='4'>暂无攻击IP数据</td></tr>");
               }
            ...
            stormcenterServer:function(){
                ...
                if(attackWarnDetail.length>0){
                    ...
                    $(".attackWarn tbody").html("<tr><td align='center' colspan='5'>暂无告警数据</td></tr>");
                }
