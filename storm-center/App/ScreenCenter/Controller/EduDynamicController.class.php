...
class EduDynamicController extends BaseController {
    ...
    public function getLocationData(){
        ...
        $json=http_post(C('STATIC_PATH')."/api/edu/locationData",array("location"=>$location),'json');
...
//        echo C('STATIC_PATH')."/api/loadDistData?location=".$location."&type=".$type;
    ...
    public function zeroDayData(){
        $json=http_post(C('STATIC_PATH')."/api/edu/zeroDayData",null,'json');
        $this->ajaxReturn($json);
    }
