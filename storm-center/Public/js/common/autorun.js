...
(function() {
    ...
    var o = {
        allInfoPages:  ["attackEvent","SecurityEvent","WebSurvey"],
        ...
        rightclick : function(value){
            if(value == "true"){
                var setting = o.rightclickoption();
                $("body").smartMenu(setting, {
                    name: "body"
                });
            }
        },
        ...
        pageScrollers: function(){
            ...
            var  cur_href = href.split("/ScreenCenter/")[1];
            cur_href=cur_href.split("/index")[0];
            ...
            var nextHref=href.replace("/ScreenCenter/"+cur_href,"/ScreenCenter/"+nextPage);
        ...
        autoPlay : function(){
            ...
            $('.autoPlay').click(function(e){
                ...
                if($("#autorun").val()=='true'){
                    ...
                    $("i",$(".autoPlay")).removeClass("fa-pause").addClass("fa-play");
