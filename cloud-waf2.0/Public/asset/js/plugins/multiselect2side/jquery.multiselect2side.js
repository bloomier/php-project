		...
		return this.each(function () {
			...
			var divUpDown =
					"<div class='ms2side__updown'>"+
						/*"<p class='SelSort btn btn' title='Sort'></p>" +
						"<p class='MoveTop btn ' title='Move on top selected option'></p>" +
						"<p class='MoveDown btn ' title='Move down selected option'></p>" +
						"<p class='MoveBottom btn ' title='Move on bottom selected option'></p>" +*/
					"</div>";
