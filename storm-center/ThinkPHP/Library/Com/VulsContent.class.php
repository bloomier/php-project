...
// 获取websiteInfo
    function initWebSiteInfo($domain){
        $param['domain'] = $domain;
        $webSiteInfo = http_post(C('STORM_CENTER_PATH')."/search/Query/Report/domainInfo", $param, 'json');
        return $webSiteInfo['other'];
    }
// 获取vulsInfo
    function initVulsInfo($domain){
        $param['domain'] = $domain;
        $vulsInfo = http_post(C('STORM_CENTER_PATH')."/search/Query/Report/vulsInfo", $param, 'json');
...
// 获取securityInfo
    function initSecurityInfo($domain){
        $param['domain'] = $domain;
        $securityInfo = http_post(C('STORM_CENTER_PATH')."/search/Query/Report/securityInfo", $param, 'json');
...
// 获取safeStateInfo
    function initSafeStateInfo($domain, $ip){
        $param['domain'] = $domain;
        $param['ip'] = $ip;
        $safeState = http_post(C('STORM_CENTER_PATH')."/search/Query/Report/safeState", $param, 'json');
