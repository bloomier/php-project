(function(){
    ...
    var app={
        ...
        header_flow:function(){
            var w=this;
            var start=function(){
                $.post(__ROOT__+"/Home/Waf/flowsInOneMin").success(function(json){
                    console.info(json);
                    var ins=json['in'];
                    var outs=json['out'];
        ...
        scoller:function(){
            ...
            var flowRank=function(){
                w.flowRankScoller= $("tbody",$('#flowRank')).itemScoller({
                    ajaxUrl:__ROOT__+'/Home/Waf/flowRank',
            ...
            var ipRank=function(){
                w.ipRankScoller= $("tbody",$('#ipRank')).itemScoller({
                    ajaxUrl:__ROOT__+'/Home/Waf/ipCountRank',
            ...
            var flowVisit=function(){
                w.visitCountRankScoller= $("tbody",$('#visitCountRank')).itemScoller({
                    ajaxUrl:__ROOT__+'/Home/Waf/visitCountRank',
            ...
            var flowAttack=function(){
                w.attackCountRankScoller= $("tbody",$('#attackCountRank')).itemScoller({
                    ajaxUrl:__ROOT__+'/Home/Waf/attackCountRank',
            ...
            var mainState=function(){
                var iplists =ipList.join(",");
                $.post(__ROOT__ + '/Home/Waf/mainState',{"ipList":iplists}).success(function (json) {
                    $(".waf-items").html("");
                    var IpDataList = [];
           ...
           //当天受攻击次数
            var attackTimes=function(){
                 $.post(__ROOT__ + '/Home/Waf/attackTimes').success(function (json) {
            ...
            var domainCount=function(){
                $.post(__ROOT__ + '/Home/Waf/domainCount').success(function (json) {
        ...
        normalVisit:function(){
                ...
                var start=function(){
                    ...
                    $.post(__ROOT__ + '/Home/Waf/flowNormalCounterList').success(function (json) {
        ...
        attactTimes:function(){
            ...
            require([
                ...
                var start=function(){
                    $.post(__ROOT__ + '/Home/Waf/visitAttackCounterList').success(function (json) {
        ...
        initWarnModel:function(){
            ...
            $('#myModal').on("shown.bs.modal",function(){
                ...
                $.post(__ROOT__+'/Home/Waf/flowRank',{"point":2}).success(function(json){
                    //console.info(json);
                ...
                $.post(__ROOT__+'/Home/Waf/ipCountRank',{"point":2}).success(function(json){
                    //console.info(json);
                    var visitIP = {};
                    var attackIP = {};
                    var ipCount = [];
