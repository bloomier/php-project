                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element text-center">
                            <span><img alt="image" class="img-circle" src="/frame/Public/asset/img/user.jpg" /></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li>
                                    <!--<a class="" href="/frame/index.php/Admin/Index/index" >主菜单</a>-->
                                    <a class="J_menuItem" href="/frame/index.php/Admin/Setting/index" >个人设置</a>
                                </li>

                                <li class="divider"></li>
                                <li><a href="/frame/index.php/Admin/Login/logout" tppabs="/frame/index.php/Admin/Login/logout">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        <div class="logo-element">综分</div>
                    </li>
                    <li>
                        <a class="J_menuItem" href="/frame/index.php/Home/Index/ipGroup" data-index="8">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse " aria-expanded="true" style="">
                            <li>
                                <a class="J_menuItem" href="/frame/index.php/Home/Index/tree" data-index="56"><i class="fa fa-user"></i>用户管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/frame/index.php/Home/Index/table" data-index="56"><i class="fa fa-users"></i>角色管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/frame/index.php/<?php echo ($cMenu["name"]); ?>" data-index="56"><i class="fa fa-menu"></i>菜单管理</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="dropdown hidden-xs">
                            <a class="right-sidebar-toggle J_menuItem" aria-expanded="false"  href="#">
            ...
            <div class="row content-tabs maxture">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="/frame/index.php/Home/Index/home">首页</a>
                    </div>
                </nav>
                ...
                <a href="/frame/index.php/Admin/Login/logout"  class="roll-nav roll-right J_tabExit"><i class="fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/frame/index.php/Home/Index/ipGroup" data-id="/frame/index.php/Home/Index/ipGroup" frameborder="0"  seamless></iframe>
            </div>
            <div class="footer maxture">
                <div class="pull-right">&copy; 2007-2016 <a href="http://www.xxxx.com.cn/"  target="_blank">XXXX技术有限公司</a>
                </div>
            </div>
        </div>
    </div>
