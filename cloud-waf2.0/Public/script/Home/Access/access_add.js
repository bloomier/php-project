...
(function(){
    ...
    var o={
        ...
        view:function(){
            ...
            //$('input[type="radio"][name="action"]').iCheck();
        },
        initTree: function(){
    ...
    var functions = {
        ...
        addAccess: function(){
            ...
            if(ip == ''){
                ...
                swal({ title: '请填写ip', type: 'warning', confirmButtonText: "确定"});
                return ;
            }

            if(!setting.ipRegex.test(ip)){
                //storm.alertMsg('请填写合法ip',"danger");
                swal({ title: '请填写合法ip', type: 'warning', confirmButtonText: "确定"});
                return ;
            }
            ...
            if(time == 1){//最长时长为3小时
                ...
                if(time == 0){
                    swal({ title: '请填写限定时间', type: 'warning', confirmButtonText: "确定"});
                    return ;
                }
            }
            ...
            $.post(__ROOT__ + "/Home/Access/addOrUpdateAccess",param).success(function(json){
                if(json.code && json.code == 1){
                    ...
                    swal({ title: json.msg, type: 'info', confirmButtonText: "确定"});
                }
            });
        }
    }
