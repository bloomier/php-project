...
(function(){
                ...
                rowCallback:function( nRow, aData, index ){
                    ...
                    deleteBtn.bind("click",function(){
                        ...
                        storm.confirm("您确定要删除吗？",function(){
                            ...
                            console.info(setting.newSiteList);
                        });
                    });
    ...
    var functions = {
        ...
        addSite: function(){
            ...
            var param = {siteName: siteName, ip: ip, port: port,
                siteList: setting.newSiteList,is_waf_warning:is_waf_warning,
                loophole_warning: loophole_warning,
                domains: domains, is_http: is_http, cert_public: cert_public,
                cert_private: cert_private, cert_ca_link: cert_ca_link,
                protect_mode: protect_mode,is_ddos: is_ddos,
                InstanceId: highInstance, is_loophole_scan: is_loophole_scan,
                is_available: is_available, available_warning: available_warning
            };
            $.extend(param, {userAddList: setting.userAddList});
            //$.post(__ROOT__ + "/Home/Sites/testArr",param).success(function(json){
            //    Message.init({
            //        text: json.msg,
            //        type: 'success'
            //    });
            //});
            //// console.info(setting.userAddList);
            //return ;
