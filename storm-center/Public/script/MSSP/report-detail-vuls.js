...
(function(){
                        ...
                        if(day_p != 'count'){
                            $.each(day_v, function(event_p, event_v){
                                if(event_p != 'count'){
                                    ...
                                    $(".event_type",wraper).html(event_v['event_type']);
    ...
    vuls={
        ...
        loadData:function(domain,callback){
            var w=this;
            $.post(__ROOT__+"/MSSP/Report/vulsData",{domain:domain}).success(function(json){
                w.vulsData=json;
                callback&&callback();
            });
        },
        view:{
            ...
            initSafeState:function(values){
                ...
                if(values['room_domain']){
                    __function__.initSafeState(values['room_domain'], $("#web_safe-room_table"), "web_safe-room_table");
                }
                if(values['ip_domain']){
