...
<head>
    <title>系统登录</title>
    <meta charset="utf-8">
    <link href="/cloud-waf2.0/Public/asset_os/css/common.css" rel="stylesheet" type="text/css" />
    <link href="/cloud-waf2.0/Public/asset_os/css/login.css" rel="stylesheet" type="text/css" />

</head>
<body class="login-bg" onkeydown="keydown()">
<div class="wrap">
    <div class="logo"></div>
    <!--<form action="/cloud-waf2.0/index.php/Home/Login/login2"  method="post" onSubmit="return myCheck()">-->
    <div id="form">
        <div class="f-bd">
...
<div class="none-btn">
    <a class="btn btn-default btn-page-toggle" href="/cloud-waf2.0/index.php/Home/Login/index.html" type="button">登录</a>
</div>
<!--<div class="wrapper">
    <img src="/cloud-waf2.0/Public/image/MSSP/login_bg.png" alt="" height="100%" width="100%" style="position:fixed;"/>
</div>-->
<input id="rootPath" type="hidden" value="/cloud-waf2.0/index.php">
<script type="text/javascript" src="/cloud-waf2.0/Public/asset_os/js/jquery/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="/cloud-waf2.0/Public/asset_os/js/jquery/jquery.md5.js"></script>
<script src="/cloud-waf2.0/Public/asset/js/jquery/jquerycookie.js" ></script>
<script type="text/javascript" src="/cloud-waf2.0/Public/script/Admin/login.js"></script>
