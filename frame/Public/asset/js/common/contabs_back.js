$(function() {
    ...
    function c() {
        ...
        $.cookie("currentPage",o,{path:__ROOT__+"/Home/Index"});
            ...
            if ($(this).data("id") == o) {
                if (!$(this).hasClass("active")) {
                    ...
                    $(".J_mainContent .J_iframe").each(function() {
                        if ($(this).data("id") == o) {
                            var currentFrameHref=this.contentWindow.location.href;
                            if(currentFrameHref.indexOf(o)==-1){
                                $(this).attr("src",o);
                            }
                            $(this).show().siblings(".J_iframe").remove();
                            return false
                        }
                    })
                }else{
        ...
        if (k) {
            ...
            //console.info($(".J_menuTabs .page-tabs-content"));
